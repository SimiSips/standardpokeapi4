...
import dev.ronnie.standardbankpokeapi.adapters.LoadingStateAdapter
import dev.ronnie.standardbankpokeapi.adapters.PokemonAdapter
import dev.ronnie.standardbankpokeapi.databinding.FragmentPokemonListBinding
import dev.ronnie.standardbankpokeapi.model.PokemonResult
import dev.ronnie.standardbankpokeapi.utils.PRODUCT_VIEW_TYPE
import dev.ronnie.standardbankpokeapi.utils.toast
import dev.ronnie.standardbankpokeapi.utils.toggle
import dev.ronnie.standardbankpokeapi.viewmodels.PokemonListViewModel
...
class PokemonListFragment : Fragment(R.layout.fragment_pokemon_list) {
    ...
    private val adapter =
        PokemonAdapter { pokemonResult: PokemonResult, picture: String? ->
            navigate(
                pokemonResult,
                picture
            )
...
//setting the status bar color back
    ...
    private fun navigate(pokemonResult: PokemonResult, picture: String?) {
        binding.root.findNavController()
            .navigate(
                PokemonListFragmentDirections.toPokemonStatsFragment(
                    pokemonResult, picture
                )
            )
    }
