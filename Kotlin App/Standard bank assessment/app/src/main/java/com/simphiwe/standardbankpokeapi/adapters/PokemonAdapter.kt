package dev.ronnie.standardbankpokeapi.adapters
...
import dev.ronnie.standardbankpokeapi.databinding.ListItemPokemonBinding
import dev.ronnie.standardbankpokeapi.model.PokemonResult
import dev.ronnie.standardbankpokeapi.utils.NETWORK_VIEW_TYPE
import dev.ronnie.standardbankpokeapi.utils.PRODUCT_VIEW_TYPE
import dev.ronnie.standardbankpokeapi.utils.getPicUrl
        ...
        fun bind(pokemonResult: PokemonResult) {
            binding.apply {
                ...
                root.setOnClickListener {
                    navigate.invoke(pokemonResult, picture)
                }
            }
